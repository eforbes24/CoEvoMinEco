...
// Init the agent
void Prey::Set(int networksize, double prey_gain, double prey_s_width, double prey_frate, double prey_feff, double prey_metaloss, double prey_b_thresh, double prey_PCOT_scalar, double prey_NCOT_scalar, double prey_NCOT_thresh)
{
	size = networksize;
	gain = prey_gain; 
    ...
    mov_dist = 0.0;
    PCOT = prey_PCOT_scalar;
    NCOT = prey_NCOT_scalar;
    NCOT_thresh = prey_NCOT_thresh;
    // FITNESS TRACKER
    fitness = 0.0;
}
...
// Sense 
void Prey::Sense(TVector<double> &food_pos, TVector<double> &pred_loc, bool hutchflag, int hutchL, int hutchR)
{
	// Sense
